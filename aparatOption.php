			...
			<div id="content" style="padding:30px">
				...
				<table width="100%" id="dispare3">
					...
					<?php if(!$isOff) {
						...
						$safeQuery = mysql_real_escape_string($r);
						...
						if(!$isInDepozit && !$isOff) {?>
							...
							<form action ="mutaAparatInDepozit.php" method="GET" id="f1">
								...
								<fieldset>
									...
									$r = "SELECT a,b from indexElectronic WHERE idAparat='".$aparat['id']."' AND a!='' AND b!='' order by data DESC limit 0,1";
									$safeQuery = mysql_real_escape_string($r);
							...
							if(!$isOff) {?>
								...
								<form action="mutaAparatLaFirma.php" method="GET">
									<fieldset>
										...
										<?php
										$x = "SELECT id,nume from firma WHERE activa='1' AND id != '".$_GET['idFirma']."'";
										$safeQuery = mysql_real_escape_string($x);
