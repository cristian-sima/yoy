<?php 
	...
	/**
	 *
	 * Aceasta situatie contine toate aparatele care mai exista in firma in prezent si adauga aparatul primit prin parametrii	 * @author			Cristian Sima
	 * @data			12.02.2014
	 * @version			1.2
	 *
	 */
	class SituațieMecanicaGraficaCompletaAparatNou extends SituațieMecanicaGraficaCompleta
	{
		/**
		 *
		 * Realizeaza o noua situatie. Aceasta situatie contine toate aparatele care mai exista in firma in prezent si adauga aparatul primit prin parametrii
		 * 
