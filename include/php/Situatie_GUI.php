...
class Situatie_GUI
{
		...
		$this->html.= '
					<table class="situatie_data" id="situatie_data">
						...
						<thead>
							<tr>
								<th> Nr. <br/> Crt.</th>
								<th> Seria <br />Masinii</th>
								<th colspan="3">Indexul contoarelor la<br/>inceput (Si)</th>
								<th colspan="3">Indexul contoarelor la<br/>sfarsit (Sf)</th>
								<th colspan="3">Factor de<br/>multiplicare (F)</th>
								<th colspan="3">Diferenta indexuri contoare<br />(D) = (Sf-Si)xF</th>
								<th> Sold<br/>impulsuri</th>
								<th> Pret/<br/>impuls</th>
								<th> Incasari</th>
							</tr>
							<tr>
								<th></th>
		...
		if($this->displayBilete && $this->getBilete() != null)
		{
			...
			$this->html.= '
					...
					<tr>	
						...
						<td class="yellow white_prt">INCEPUT</td>
						<td class="yellow white_prt" >SFARSIT</td>
					</tr>						
					</table>
					';
			...
			if($this->displayDefaultBilete)
			{
				...
				$this->html.= '
					<tr>	
						...
						'.((($this->displayAddCarnet) == true)?'<span onclick="adaugaCarnet()" style="color:green;cursor:pointer"  class="hide_prt">Adauga carnet</span>':'').'
			...
			foreach($carnete as $carnet)
			{
				$this->html.= '
					<tr id="carnet_'.$nr.'" >	
						...
						<a class="hide_prt" '.(($this->isInteractive)?(""):("style='display:none'")).' onclick="stergeCarnet('.$nr.')" tabindex="-1">Sterge carnet</a>
	...
	{
		$this->html.= '<a id="jump_salveaza" class="hide_prt" href="" style="color:white">Salveaza</a></form>';
		$this->html.= '</div>';
	}
}