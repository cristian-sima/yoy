...
class RegistruGUI
{
	...
	public function afiseaza()
	{
		...
		{
			echo '<span style="color:red"> Se pare ca nu exista date pentru <span style="color:black">'.$this->content->getTitle().'</span><span style="color:red"> din </span><span style="color:black">'.$this->content->getDateTitle().'</span>';
	...
	/**
	 *
	 *  Afiseaza resursa CSS care este necesara pentru tabel
	 *
	 */
	...
	/**
	 * Afiseaza soldul precendent pentru o pagina
	 */
	...
	/**
	 * Afiseaza randurile paginii. Aceste randuri incepe de la $i*$numaruldePagini.
	 *
	 * @param int $i				Numarul paginii
	 */
	...
	//	$this->content->getSumeRaportate()->actualizeazaPlati($total_pagina_plati);
		...
		{
			$row	= $this->getEmptyRow();
			$row[$this->content->getTotalTitleColumn()] = "<span class='bold'>TOTAL PAGINA</span>";
	...
	/**
	 * Afiseaza un rand din tabel. Randul este afisat pentru toate coloanele
	 *
