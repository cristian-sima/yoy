<?php 
	...
	Page::showHeader();
	Page::showContent();	
	Page::showHeading("Registru General", '<input type="button" class="disp" value="Printeaza" onclick="window.print()">&nbsp; <a onclick="goTo('."'".'selecteaza_situatie.php'."'".')" href="#"><input type="button" value="Înapoi la Situatii" /></a>');
