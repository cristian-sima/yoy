<?php
	...
	Page::showContent();
		...
		Page::showHeading("Vizualizaţi toate aparate active si inactive",'<input type="button" value="Adaugati aparat in depozit" onclick="document.location='."'".'adauga_aparat.php'."'".'" />');
