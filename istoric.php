<?php
	...
	Page::showHeading("Vizualizati premii acordate", '
			<input class="disp" type="button" value="Printează" class="disp" onclick="window.print();" /> 
			'.(($_GET['id_firma'] != '')?('<input	class="disp" type="button" value="Acorda premiu" class="disp" onclick="document.location='."'".'acorda_premii.php?id_firma='.$_GET['id_firma']."'".';" />'):"").'');
