...
Page::showHeading('<img src="img/setari.png" align="absmiddle" /> Actualizare situații ', "");
...
console("<span style='weight:bold;background:green;color:white'> Totul este ok acum ! </span> <span style='color:red'>Vă rugăm să actualizați totalul pentru luna respectivă.</span> <a href='inchide_situatie_luna.php?an=".$_POST['an']."&luna=".$_POST['luna']."&id_firma=".$_POST['id_firma_do']."&data=".$_POST['from']."'>aici</a>");
	...
	echo '
		...
		Până la inclusiv: <input type="text" id="to" name="to" class="datepicker" value="'.$_GET['data'].'" placeholder="Alegeți data"><br />
		';
		echo'Pentru firma:
			...
			$data = $_GET['data'];
		echo ' <br />
		<input type="submit" id="trimis" value="Actualizeaza (vă rugăm să așteptați după ce dați click)!" />
		</form>
		<script>
